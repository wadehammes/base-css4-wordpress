...
add_action('after_setup_theme','base_start', 16);
...
function base_get_the_author_posts_link() {
	...
	$link = sprintf(
		...
		esc_attr( sprintf( __( 'Posts by %s', 'basetheme' ), get_the_author() ) ), // No further l10n needed, core will take care of this one
		get_the_author()
	);
	return $link;
}
